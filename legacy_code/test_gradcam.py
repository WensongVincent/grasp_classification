...
def main(config_path):
    ...
    # finetune
    evaluation(model=model, dataloader=dataloader, dataset_sizes=dataset_sizes, device=device, result_path=save_path, grad_cam=grad_cam)
...
if __name__ == '__main__':
    ...
    main('/mnt/afs/huwensong/workspace/R3_grasp_classification/configs/config_test_0814_1_gradcam.json')