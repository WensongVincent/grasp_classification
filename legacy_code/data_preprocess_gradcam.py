...
# '/mnt/afs/zhouzhijie/data/temp/20240618_R3v0.3_6.PieceGrasp_P1_TestData_hhh.jsonl',
#                 '/mnt/afs/zhouzhijie/data/temp/20240618_R3v0.3_6.PieceGrasp_P1_TrainData_hhh.jsonl',
...
OUTPUT_VERSION = '0806_2' ###### CHANGE this for new metadata ######
...
def main():
    ...
    # Write into file
    with open(f'{OUTPUT_PATH}/metadata_{OUTPUT_VERSION}_test_gradcam.json', 'w') as f:
